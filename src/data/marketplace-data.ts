...
export const featuredItems: ItemType[] = [
  {
    ...
    description:
      "Advanced power gauntlet with neural interface for enhanced strength and precision.",
    stats: {
      damage: 85,
      accuracy: 70,
      range: 30,
  ...
  },
  {
    ...
    description:
      "Compact energy pistol with focused plasma discharge and minimal heat buildup.",
    stats: {
      damage: 75,
      accuracy: 80,
      range: 60,
  ...
  },
  {
    ...
    description:
      "Vibrating molecular edge capable of cutting through most materials with minimal resistance.",
    stats: {
      damage: 95,
      accuracy: 90,
      range: 10,
  ...
  },
  {
    ...
    description:
      "Stealth-optimized sidearm with integrated sound suppression and heat signature masking.",
    stats: {
      damage: 65,
      accuracy: 85,
      range: 50,
...
export const allItems: ItemType[] = [
  ...
  },
  {
    ...
    description:
      "Silent but deadly energy bow with customizable arrow types and adjustable draw strength.",
    stats: {
      damage: 70,
      accuracy: 85,
      range: 75,
  ...
  },
  {
    ...
    description:
      "Deployable energy shield with adaptive resistance to various damage types.",
    stats: {
      damage: 10,
      accuracy: 100,
      range: 30,
  ...
  },
  {
    ...
    description:
      "Heavy plasma weapon with area effect damage and shield penetration capabilities.",
    stats: {
      damage: 90,
      accuracy: 65,
      range: 55,
